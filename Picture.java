...
public class Picture{
	...
	rgbGraceValueAmount: The amount that a similar picture's RGB value can be and still be considered "similar". Lower means more precise similarities.
	...
	*/
	public boolean isEqualTo(Picture picToCompareAgainst, boolean checkSimilar, int algorithmNumber, int rgbGraceValueAmount, double acceptableSimilarity, boolean hardCompare){
			...
			if(algorithmNumber==0){
				...
				for(int i=0; i<width; i++){
					for(int j=0; j<height; j++){
						...
						//The second picture's pixel value should be somewhere in the range of +/- the rgbGraceValueAmount.
						if(!(pic1Color.getRed()+rgbGraceValueAmount >= pic2Color.getRed() && pic1Color.getRed()-rgbGraceValueAmount <= pic2Color.getRed())){
							if(hardCompare){
								return false;
							}
							else{
						...
						else if(!(pic1Color.getGreen()+rgbGraceValueAmount >= pic2Color.getGreen() && pic1Color.getGreen()-rgbGraceValueAmount <= pic2Color.getGreen())){
							if(hardCompare){
								return false;
							}
							else{
						...
						else if(!(pic1Color.getBlue()+rgbGraceValueAmount >= pic2Color.getBlue() && pic1Color.getBlue()-rgbGraceValueAmount <= pic2Color.getBlue())){
							if(hardCompare){
								return false;
							}
							else{
						...
						else if(!(pic1Color.getAlpha()+rgbGraceValueAmount >= pic2Color.getAlpha() && pic1Color.getAlpha()-rgbGraceValueAmount <= pic2Color.getAlpha())){
							if(hardCompare){
								return false;
							}
							else{
